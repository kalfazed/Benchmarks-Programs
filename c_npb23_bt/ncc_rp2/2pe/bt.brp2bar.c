...
/* option-log</homesc2/kisimoto/bin/x86_64-linux/ompcbe.b16b2efaff96bbe2eb1537f70ab4b17866eedbec -c-sche --goto-return --cfe2 --while --if --set-argv-func -b 5 --executions --shc-aligndata --cache-line-size 32 --volatile --flush --use-rp2barrier --literal bt.mq> */
