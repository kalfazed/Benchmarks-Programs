...
/* option-log</homesc2/kisimoto/bin/x86_64-linux/ompcbe.b16b2efaff96bbe2eb1537f70ab4b17866eedbec -c-sche --goto-return --cfe2 --while --if --set-argv-func -b 5 --executions --shc-aligndata --cache-line-size 32 --volatile --flush --b-onchipshared --literal bt.mq> */
...
#pragma oscar onchipshared(M99_CL0_PC0_SS_MTG_COUNT3)
volatile int M99_CL0_PC0_STASCHE_END_FLAG3[2][2];
#pragma oscar onchipshared(M99_CL0_PC0_STASCHE_END_FLAG3)
volatile int M99_CL0_PC0_STASCHE_RBBE_FLAG3[2];
#pragma oscar onchipshared(M99_CL0_PC0_STASCHE_RBBE_FLAG3)
volatile int M99_CL0_PC0_SCHE_FLG3[2];
#pragma oscar onchipshared(M99_CL0_PC0_SCHE_FLG3)
/* == VARIABLE FOR STATIC SCHEDULER (mtg_id=4) == */
volatile int M99_CL0_PC0_SS_MTG_COUNT4[2];
#pragma oscar onchipshared(M99_CL0_PC0_SS_MTG_COUNT4)
volatile int M99_CL0_PC0_STASCHE_END_FLAG4[2][2];
#pragma oscar onchipshared(M99_CL0_PC0_STASCHE_END_FLAG4)
volatile int M99_CL0_PC0_STASCHE_RBBE_FLAG4[2];
#pragma oscar onchipshared(M99_CL0_PC0_STASCHE_RBBE_FLAG4)
volatile int M99_CL0_PC0_SCHE_FLG4[2];
#pragma oscar onchipshared(M99_CL0_PC0_SCHE_FLG4)
/* == VARIABLE FOR STATIC SCHEDULER (mtg_id=5) == */
volatile int M99_CL0_PC0_SS_MTG_COUNT5[2];
#pragma oscar onchipshared(M99_CL0_PC0_SS_MTG_COUNT5)
volatile int M99_CL0_PC0_STASCHE_END_FLAG5[2][2];
#pragma oscar onchipshared(M99_CL0_PC0_STASCHE_END_FLAG5)
volatile int M99_CL0_PC0_STASCHE_RBBE_FLAG5[2];
#pragma oscar onchipshared(M99_CL0_PC0_STASCHE_RBBE_FLAG5)
volatile int M99_CL0_PC0_SCHE_FLG5[2];
#pragma oscar onchipshared(M99_CL0_PC0_SCHE_FLG5)
...
#pragma oscar onchipshared(M108_CL0_PC0_SS_MTG_COUNT6)
volatile int M108_CL0_PC0_STASCHE_END_FLAG6[2][2];
#pragma oscar onchipshared(M108_CL0_PC0_STASCHE_END_FLAG6)
volatile int M108_CL0_PC0_STASCHE_RBBE_FLAG6[2];
#pragma oscar onchipshared(M108_CL0_PC0_STASCHE_RBBE_FLAG6)
volatile int M108_CL0_PC0_SCHE_FLG6[2];
#pragma oscar onchipshared(M108_CL0_PC0_SCHE_FLG6)
/* == VARIABLE FOR STATIC SCHEDULER (mtg_id=7) == */
volatile int M108_CL0_PC0_SS_MTG_COUNT7[2];
#pragma oscar onchipshared(M108_CL0_PC0_SS_MTG_COUNT7)
volatile int M108_CL0_PC0_STASCHE_END_FLAG7[2][2];
#pragma oscar onchipshared(M108_CL0_PC0_STASCHE_END_FLAG7)
volatile int M108_CL0_PC0_STASCHE_RBBE_FLAG7[2];
#pragma oscar onchipshared(M108_CL0_PC0_STASCHE_RBBE_FLAG7)
volatile int M108_CL0_PC0_SCHE_FLG7[2];
#pragma oscar onchipshared(M108_CL0_PC0_SCHE_FLG7)
/* == VARIABLE FOR STATIC SCHEDULER (mtg_id=8) == */
volatile int M108_CL0_PC0_SS_MTG_COUNT8[2];
#pragma oscar onchipshared(M108_CL0_PC0_SS_MTG_COUNT8)
volatile int M108_CL0_PC0_STASCHE_END_FLAG8[2][2];
#pragma oscar onchipshared(M108_CL0_PC0_STASCHE_END_FLAG8)
volatile int M108_CL0_PC0_STASCHE_RBBE_FLAG8[2];
#pragma oscar onchipshared(M108_CL0_PC0_STASCHE_RBBE_FLAG8)
volatile int M108_CL0_PC0_SCHE_FLG8[2];
#pragma oscar onchipshared(M108_CL0_PC0_SCHE_FLG8)
/* == VARIABLE FOR STATIC SCHEDULER (mtg_id=9) == */
volatile int M108_CL0_PC0_SS_MTG_COUNT9[2];
#pragma oscar onchipshared(M108_CL0_PC0_SS_MTG_COUNT9)
volatile int M108_CL0_PC0_STASCHE_END_FLAG9[2][2];
#pragma oscar onchipshared(M108_CL0_PC0_STASCHE_END_FLAG9)
volatile int M108_CL0_PC0_STASCHE_RBBE_FLAG9[2];
#pragma oscar onchipshared(M108_CL0_PC0_STASCHE_RBBE_FLAG9)
volatile int M108_CL0_PC0_SCHE_FLG9[2];
#pragma oscar onchipshared(M108_CL0_PC0_SCHE_FLG9)
...
#pragma oscar onchipshared(M101_CL0_PC0_barrier_flg)
volatile int M102_CL0_PC0_barrier_flg[2][2][3];
#pragma oscar onchipshared(M102_CL0_PC0_barrier_flg)
...
#pragma oscar onchipshared(M106_CL0_PC0_barrier_flg)
volatile int M109_CL0_PC0_barrier_flg[2][2][4];
#pragma oscar onchipshared(M109_CL0_PC0_barrier_flg)
volatile int M116_CL0_PC0_barrier_flg[2][2][4];
#pragma oscar onchipshared(M116_CL0_PC0_barrier_flg)
volatile int M119_CL0_PC0_barrier_flg[2][2][4];
#pragma oscar onchipshared(M119_CL0_PC0_barrier_flg)
volatile int M95_CL0_PC0_barrier_flg[2][2][2];
#pragma oscar onchipshared(M95_CL0_PC0_barrier_flg)
...
#pragma oscar onchipshared(M110_CL0_PC0_barrier_flg)
...
#pragma oscar onchipshared(M118_CL0_PC0_barrier_flg)
volatile int M117_CL0_PC0_barrier_flg[2][2][3];
#pragma oscar onchipshared(M117_CL0_PC0_barrier_flg)
volatile int M105_CL0_PC0_barrier_flg[2][2][3];
#pragma oscar onchipshared(M105_CL0_PC0_barrier_flg)
volatile int M121_CL0_PC0_barrier_flg[2][2][6];
#pragma oscar onchipshared(M121_CL0_PC0_barrier_flg)
volatile int M120_CL0_PC0_barrier_flg[2][2][2];
#pragma oscar onchipshared(M120_CL0_PC0_barrier_flg)
#pragma section
