...
/* option-log</homesc2/kisimoto/bin/x86_64-linux/ompcbe.b16b2efaff96bbe2eb1537f70ab4b17866eedbec -c-sche --goto-return --cfe2 --while --if -b 5 --executions --shc-aligndata --cache-line-size 32 --volatile --flush --literal mg.mq> */
