...
/* option-log</homesc2/kisimoto/bin/x86_64-linux/ompcbe.c17ad20d3a3f5461091f55cd15e0b4be5d00579f -c-sche --goto-return --cfe2 --while --if -b 5 --use-rp2barrier --literal sp.mq> */
